...
from .models import Team, Player, Sell, SellHistory #GameHistory
...
from .perm import IsTransferOfOwnPlayer, IsNotTransferOfOwnPlayer
...
class TransferHistoryViewSet(GenericViewSet, ListModelMixin, RetrieveModelMixin):
    queryset = SellHistory.objects.all()
    permission_classes = [
        IsAuthenticated,
    ]
...
# class GameHistoryViewSet(GenericViewSet, ListModelMixin, RetrieveModelMixin):
