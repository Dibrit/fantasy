...
from .models import Team, Player, SellHistory, Sell, GameHistory
from regist.serializers import UserSerializer
...
class TransferCreateSerializer(serializers.ModelSerializer):
    ...
    def validate(self, attrs):
        ...
        if Sell.objects.filter(player=attrs["player"], is_sold=False).exists():
